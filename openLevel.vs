...
vec4 simplexNoise(vec3 vert){
	// get a turbulent 3d noise using the normal, normal to high freq
	  ...
	  vec3 newPosition = vert + nEC * displacement;
	  return gl_ProjectionMatrix * modelViewMatrix * vec4( newPosition, 1.0 );
...
void main(void)
{
  ...
  osVert = gl_Vertex;
  vec3 v31 = vec3(osVert.x,osVert.y,osVert.z);
  osVert = simplexNoise(v31);
